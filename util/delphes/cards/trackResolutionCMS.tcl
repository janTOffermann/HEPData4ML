...
# p = pt * cosh(eta)
# => dp = d(pt * cosh(eta)) = \sqrt{ (pt * sinh(eta))^2 * deta^2 + cosh(eta)^2 * dpt^2 }
# => dp^2 = pt^2 * sinh^2(eta) * deta^2 + cosh(eta)^2 * dpt^2
#         = pt^2 * sinh^2(eta) / (ctgTheta^2 + 1) * d(ctgTheta)^2 + cosh(eta)^2 * dpt^2
#         = pt^2 * sinh^2(eta) / (sinh^2(eta) + 1) * d(ctgTheta)^2 + cosh(eta)^2 * dpt^2
