/*
 *  This is a modified copy of Delphes' "ExDelphesDisplay" class. I have made
 *  this copy since I needed to modify some features, but I am unsure if it
 *  is worth merging those into Delphes (or using my own fork). - Jan
 *
...
ExDelphesDisplay::ExDelphesDisplay()
{
...
void ExDelphesDisplay::ImportGeomRPhi(TEveElement *el)
{
  fRPhiMgr->ImportElements(el, fRPhiGeomScene);
}

void ExDelphesDisplay::ImportGeomRhoZ(TEveElement *el)
{
  fRhoZMgr->ImportElements(el, fRhoZGeomScene);
}

void ExDelphesDisplay::ImportCaloRPhi(TEveCalo3D *calo)
{
  fRPhiMgr->ImportElements(calo, fRPhiCaloScene);
}

void ExDelphesDisplay::ImportCaloRhoZ(TEveCalo3D *calo)
{
  fRhoZMgr->ImportElements(calo, fRhoZCaloScene);
}

void ExDelphesDisplay::ImportCaloLego(TEveCaloLego *calo)
{
...
void ExDelphesDisplay::ImportEventRPhi(TEveElement *el)
{
  fRPhiMgr->ImportElements(el, fRPhiEventScene);
}

void ExDelphesDisplay::ImportEventRhoZ(TEveElement *el)
{
...
void ExDelphesDisplay::DestroyEventRPhi()
{
  fRPhiEventScene->DestroyElements();
}

void ExDelphesDisplay::DestroyEventRhoZ()
{
