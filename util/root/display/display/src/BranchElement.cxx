...
namespace Display{
  ...
  template <>
  void BranchElement<TEveElementList>::Reset() { data_->DestroyElements(); }
  // template <>
  ...
  template <>
  void BranchElement<TEveTrackList>::Reset() { data_->DestroyElements(); }
  // template <>
