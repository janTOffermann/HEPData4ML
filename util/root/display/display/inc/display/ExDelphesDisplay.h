...
#ifndef ExDelphesDisplay_h
#define ExDelphesDisplay_h
...
public:
  ...
  TEveScene* GetRPhiCaloScene(){return fRPhiCaloScene;};
  TEveScene* GetRhoZCaloScene(){return fRhoZCaloScene;};
  TEveScene* GetLegoCaloScene(){return fLegoCaloScene;};
