...
def main(args):
    ...
    parser.add_argument('-j', '--jobdir', type=str, help='Output directory -- where the condor jobs will go.', default='job0')
    ...
    template = '{} "{}" {} {} {} {} {} {}'.format(nevents,ptbins_str,sep_truth, n_sep_truth, do_h5, '{}',split,'{}')
